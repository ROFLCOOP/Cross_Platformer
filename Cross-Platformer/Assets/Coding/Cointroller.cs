...
public class Cointroller : MonoBehaviour {
    ...
    Vector3[] hrr_coin_spots = new Vector3[7] { new Vector3(-9.87f, 10.33f, 2.35f), new Vector3(8.54f, 10.33f, 5.61f), new Vector3(-0.61f, 10.33f, 7.78f), new Vector3(22.1f, 3.76f, -1.73f), new Vector3(-3.55f, 3.76f, 10.62f), new Vector3(12.78f, 3.76f, 29.94f), new Vector3(-33.47f, 3.0f, 22.71f) };
    ...
    private void OnTriggerEnter(Collider collision)
    {
        ...
        if (otherCollider == P1Obj) { umpire_fnc.scorePoint(1); moveCoin(); }
        else if (otherCollider == P2Obj) { umpire_fnc.scorePoint(2); moveCoin(); }
